...
1. 确认当前产品版本为 `v1.0.2`，目录版本为 `20260823-011b26367022`。
2. 阅读本文、`docs/RELEASE_PROCESS.md`、`README.md`、`CHANGELOG.md` 和 `VERSION.json`。
3. 执行 `git log --oneline --decorate -10` 和 `git tag -n`，确认 `v1.0.2` tag 与 release commit。
...
| 2026-08-25 23:28 | `release: v1.0.2` | `release: v1.0.2`，移除初始跳过拾取占位符金叶子 |
