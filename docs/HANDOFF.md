...
1. 确认当前产品版本为 `v1.0.1`，目录版本为 `20260823-011b26367022`。
2. 阅读本文、`docs/RELEASE_PROCESS.md`、`README.md`、`CHANGELOG.md` 和 `VERSION.json`。
3. 执行 `git log --oneline --decorate -10` 和 `git tag -n`，确认 `v1.0.1` tag 与 release commit。
...
| 2026-08-25 23:25 | `release: v1.0.1` | `release: v1.0.1`，全量合入插件默认初始配置对齐补丁 |
