...
1. 确认当前产品版本为 `v1.2.0`（commit `release: v1.2.0` / tag `v1.2.0`），目录版本为 `20260823-011b26367022`。
2. 阅读本文、`docs/RELEASE_PROCESS.md`、`README.md`、`CHANGELOG.md` 和 `VERSION.json`。
3. 执行 `git log --oneline --decorate -10` 和 `git tag -n`，确认 `v1.2.0` tag 与 release commit。
...
| --- | --- |
| 产品名 | 剑网3掉落工坊 |
| 最新已发布版本 | `v1.2.0`（tag `v1.2.0`） |
| 当前工作区版本 | `v1.2.0`（正式稳定版） |
